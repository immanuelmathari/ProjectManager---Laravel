...
import { USER_STATUS_CLASS_MAP, USER_STATUS_TEXT_MAP, TASK_PRIORITY_CLASS_MAP, TASK_PRIORITY_TEXT_MAP } from '@/constraints';
...
export default function Show({auth, user, tasks, queryParams = null}) {
  ...
  queryParams = queryParams || {};
    ...
    const searchFieldChanged = (name,value) => {
        ...
        router.get(route("user.show"), queryParams);
    }
